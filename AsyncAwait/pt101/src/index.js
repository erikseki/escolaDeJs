...
async function moveAndFire(x, y, z) {
    try { // try catch utilizado para pegar o reject da promise ao inves de disparar um Error em vermelho.
        ...
        let promiseResult = await Promise.all([adjustPositionPromise, loadAmmoPromise]) // PROMISE.ALL SO VAI EXECUTAR QUANDO AS DUAS TERMINAREM DE SER EXECUTADAS (Await = aguardou a execução de tudo pra dps executar o restante do código * console.log's)
